...
| `seek-index-counts-duplicate-timestamp-packets.md` | active | - | Deduplicate presentation timestamps in build_seek_index consistently with measure_timing so VP8/VP9 alternate-reference packets cannot shift keyframe ranks and reintroduce off-by-N seeks. |
